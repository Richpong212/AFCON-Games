      ...
      <section className="w-100 mt-4">
        ...
        <div className="w-100 mt-4">
          ...
          <div className="bg-light p-4 rounded mb-4">
            ...
            <span>
              Correct Score: 3 points will be awarded for accurately predicting
              the exact final score of the game.
            </span>
          </div>
          ...
          <div className="bg-light p-4 rounded mb-4">
            ...
            <span>
              Game administrators have the authority to update game results as
              necessary.
            </span>
          </div>
          ...
          <div className="bg-light p-4 rounded mb-4">
            ...
            <span>
              Users are required to provide their amount to the admin for prize
